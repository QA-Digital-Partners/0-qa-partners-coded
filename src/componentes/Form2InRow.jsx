  ...
  return (
    <>
          <form className="pt-3" ref={form} onSubmit={(e) => handleSubmit(e, form, phone, statusRef)}>
              ...
              <div>
                    <input  type="text" 
                        className="form-control p-2 border rounded-md border-qablack w-full bg-transparent" 
                        id="name"  
                        placeholder="Name"
                        name="name"
                        required
              ...
              <div>
                ...
                <div className="col-span-12 lg:pt-4 pt-8" >
                  <div className="lg:w-5/12 w-full text-center">
                    <button className="w-full text-white bg-qablack py-2 rounded-md font-bold py-4">SEND</button>
                  </div>
