...
const SeoAgency = () => {
  ...
  return (
    ...
    <div className="container mx-auto flex flex-wrap lg:flex-nowrap lg:pt-16 pt-16" id="enterprise" ref={anchors['enterprise']} >
    ...
    {/************************* Specialized SEO by Industry Section **************************************/}
